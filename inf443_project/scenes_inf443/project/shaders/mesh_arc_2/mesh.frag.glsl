...
void main()
{
	...
	if (pow(fragment.position.x,2)+pow(fragment.position.z,2)<150.0f){
		discard;
	}
	else if (pow(fragment.position.x,2)+pow(fragment.position.z,2)<155.0f){
		vec3 color = vec3(0.41, 0.0, 0.73);
		FragColor = vec4(color, material.alpha * color_image_texture.a);
	}
	else if (155.0f<pow(fragment.position.x,2)+pow(fragment.position.z,2) && pow(fragment.position.x,2)+pow(fragment.position.z,2)<160.0f){
		vec3 color = vec3(0.0, 0.2, 0.73);
		FragColor = vec4(color, material.alpha * color_image_texture.a);
	}
	else if (160.0f<pow(fragment.position.x,2)+pow(fragment.position.z,2) && pow(fragment.position.x,2)+pow(fragment.position.z,2)<165.0f){
		vec3 color = vec3(0.03, 0.85, 0.85);
		FragColor = vec4(color, material.alpha * color_image_texture.a);
	}
	else if (165.0f<pow(fragment.position.x,2)+pow(fragment.position.z,2) && pow(fragment.position.x,2)+pow(fragment.position.z,2)<170.0f){
		vec3 color = vec3(0.11, 0.82, 0.28);
		FragColor = vec4(color, material.alpha * color_image_texture.a);
	}
	else if (170.0f<pow(fragment.position.x,2)+pow(fragment.position.z,2) && pow(fragment.position.x,2)+pow(fragment.position.z,2)<175.0f){
		vec3 color = vec3(0.44, 0.82, 0.11);
		FragColor = vec4(color, material.alpha * color_image_texture.a);
	}
	else if (175.0f<pow(fragment.position.x,2)+pow(fragment.position.z,2) && pow(fragment.position.x,2)+pow(fragment.position.z,2)<180.0f){
		vec3 color = vec3(0.92, 0.92, 0.16);
		FragColor = vec4(color, material.alpha * color_image_texture.a);
	}
	else if (180.0f<pow(fragment.position.x,2)+pow(fragment.position.z,2) && pow(fragment.position.x,2)+pow(fragment.position.z,2)<185.0f){
		vec3 color = vec3(0.89, 0.55, 0.13);
		FragColor = vec4(color, material.alpha * color_image_texture.a);
	}
	else if (185.0f<pow(fragment.position.x,2)+pow(fragment.position.z,2) && pow(fragment.position.x,2)+pow(fragment.position.z,2)<190.0f){
		vec3 color = vec3(0.89, 0.38, 0.13);
		FragColor = vec4(color, material.alpha * color_image_texture.a);
	}
	else if (190.0f<pow(fragment.position.x,2)+pow(fragment.position.z,2) && pow(fragment.position.x,2)+pow(fragment.position.z,2)<195.0f){
		vec3 color = vec3(0.91, 0.2, 0.09);
		FragColor = vec4(color, material.alpha * color_image_texture.a);
	}
	if (pow(fragment.position.x,2)+pow(fragment.position.z,2)>195.0f){
		discard;
	}
